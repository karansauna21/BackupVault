...
class SystemTrayManager {
  ...
  Future<void> init() async {
    ...
    try {
      ...
      // Gracefully catch exceptions during initialization in tests/mock environments
    }
  }
  ...
  Future<void> updateMenu({required bool isBackupRunning, required bool isPaused}) async {
    ...
    try {
      ...
      // Avoid breaking if platform channel throws in test
    }
  }
  ...
  Future<void> updateTooltip(TrayState state) async {
    ...
    try {
      ...
      // Avoid breaking if platform channel throws
    }
  }

  Future<void> destroy() async {
    // There is no explicit destroy in the system_tray 0.1.1 API, but we can set icon empty
