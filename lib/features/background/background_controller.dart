...
class BackgroundController extends Notifier<BackgroundModuleState> {
  ...
  Future<void> init() async {
    ...
    // Apply Windows startup delay & minimization options
    ...
    // Trigger Backup Engine automatically if restorePreviousSession or delay option is chosen
  ...
  Future<void> exitApp() async {
    await _backgroundService.shutdown();
    if (Platform.isWindows) {
