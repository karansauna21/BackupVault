...
import '../../core/database/notification_database.dart';
...
final notificationServiceProvider = Provider<NotificationService>((ref) {
  ...
  final platformNotif = ref.watch(platformNotificationServiceProvider);
  final service = NotificationService(repo, platformNotif);
